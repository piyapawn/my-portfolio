  ...
  return (
    <div id="carousel" className="max-w-[744px] min-w-[350px] h-fit m-auto p-8">
      ...
      <Swiper navigation={true} modules={[Navigation]} className="">
        {ProjectInfos?.map((eachItem: ProjectType) => {
          if (eachItem?.imgSrc) {
            return renderImgSlide(eachItem)
          }
        })}
      </Swiper>
      <div className="flex items-center mt-4">
        <button
          ...
          className="m-auto w-full h-[40px] p-2 rounded-xl bg-blue-300/50 hover:bg-blue-500/50 cursor-pointer text-[#344054]">
          View more
        </button>
      </div>
    </div>
